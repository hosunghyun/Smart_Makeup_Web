...
class start_Makeup():
    def __init__(self):
        ...
        self.skin_root = 'make_up\\makeup\\makeup_img\\skin'
        self.lip_root = 'make_up\\makeup\\makeup_img\\lip'
...
def main():
    # 이미지 파일 경로
    image_path = 'make_up\\makeup\\face.jpg'  # 여기에 테스트할 이미지 경로를 입력하세요
    ...
    output = makeup.run(frame, skin_val=True, lip_val=True, skin_num=1, lip_num=7, s_mix=80, l_mix=50)
