...
async def video_feed(websocket: WebSocket):
    ...
    # 웹캠 비디오 캡처 초기화
    cap = cv2.VideoCapture('C:\\Users\\hhs04\\OneDrive\\Desktop\\Smart_Makeup_Web\\smart_makeup_web\\src\\main\\resources\\static\\video\\sample5_summerskin_springlip50.mp4')
