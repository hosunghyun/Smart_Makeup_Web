...
def textWithBackground(img, text, font, fontScale, textPos, textThickness=1,textColor=(255,255,255), bgColor=(0,0,0), pad_x=3, pad_y=3, bgOpacity=0.5):
    """
...
def fillPolyTrans(img, points, color, opacity):
    ...
    overlay = img.copy()  # coping the image
    cv.polylines(overlay,[list_to_np_array],True,(0,0,0),thickness=1) # 다각형 경계
